...
class Tokenizer():
    def __init__(self, args):
        ...
        self.max_pos = self.tokenizer.model_max_length

    def _preprocess(self, src, tgt, sent_labels, use_bert_basic_tokenizer=False, is_test=False):
    ...
    def preprocess(self, ex):
        ...
        src_subtoken_idxs, sent_labels, tgt_subtoken_idxs, segments_ids, cls_ids, src_txt, tgt_txt = self._preprocess(src, tgt, src_sent_labels)
...
class DataIterator(object):
    ...
    def preprocess(self, ex, is_test):
        ex = self.tokenizer.preprocess(ex)
        src = ex['src']
